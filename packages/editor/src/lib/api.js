...
export const api = {
  ...
  startScormExport: (id) => client.post(`/api/courses/${id}/scorm-export`).then((r) => r.data),
  getScormExport: (courseId, jobId) => client.get(`/api/courses/${courseId}/scorm-export/${jobId}`).then((r) => r.data),
  scormExportDownloadUrl: (courseId, jobId) => `/api/courses/${courseId}/scorm-export/${jobId}/download`,
  listShareLinks: (id) => client.get(`/api/courses/${id}/share-links`).then((r) => r.data.share_links || []),
  createShareLink: (id, payload) => client.post(`/api/courses/${id}/share-links`, payload).then((r) => r.data.share_link),
  updateShareLink: (courseId, shareLinkId, payload) => client.patch(`/api/courses/${courseId}/share-links/${shareLinkId}`, payload).then((r) => r.data.share_link),
  revokeShareLink: (courseId, shareLinkId) => client.delete(`/api/courses/${courseId}/share-links/${shareLinkId}`),
