...
export default function TabsBlock({ block, assets, onTrigger, onTimeReached, onOpenModal, blockVisibility, variables, interactionStates, printMode, worksheetMode }) {
